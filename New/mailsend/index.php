...
<body>
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<a class="navbar-brand" href="https://sourcecodester.com">NewBorn Doctors Appointment And Management System</a>
			
	

		</div>
		<a class="btn btn-primary" href="/New/visit.php" role="button"> <i class="fas fa-backward    "></i>Back to Appointments</a>
	...
	<div class="col-md-6 well">
		...
		<div class="col-md-6">
			...
			<br />
			<a class="btn btn-primary" href="/New" role="button"> <i class="fas fa-backward    "></i> Back Home</a>
